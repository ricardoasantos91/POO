  ...
  public static void exibirMenuAdministracao(CadastroPessoa cadastro){
    ...
    switch(opcao){
      ...
      case 4:
        ...
        try{
          Pessoa pes = cadastro.buscarPorCpf(cpfB);
          pes.print();
        }
        catch(Exception e){
      ...
      case 6:
        ...
        try{
          Pessoa pessoaR = cadastro.buscarPorCpf(cpfR);

          cadastro.remover(pessoaR);
        }
        catch(Exception e){
      ...
      case 8:
        PessoaArquivo.escreverArquivo(cadastro);
